//array 
const fall = [10, 20, 30, 17, 12],
      war = [1944, 1945, 'Reich has fallen', 'diminatus', 'Berlin is burning']

function day(data: number[]) {
  return data.filter(n => n >= 17)
}
console.log(day(fall))

function month(ad: (string | number)[]) {
...
function mostrarCursos(cursos: Developer[]) { 
