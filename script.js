...
//Inference
const region = 'Omaha', day = 6, impor = 'dia D', year = 1944, month = 'June';
...
//Exercício 1
function ajustaTexto(txt) {
    return txt.trim().toLowerCase();
}
console.log(ajustaTexto(' Empire of the Clouds '));
//Exercício 2
const input = document.querySelector("input"), total = localStorage.getItem('total');
if (input && total) {
    input.value = total;
